...
<body>
	...
	<div id="printArea">
		<div id="taxInvoice">
			...
			<table
				style="margin-top: 3%; border: 1px solid #000; border-collapse: collapse; width: 100%;">
				<tr>
				...
				<c:forEach items="${ invoice.invoiceItemsList }" var="invoiceItem"
					varStatus="loopCount">
					<tr>
						<td style="border: 1px solid #000;">${ loopCount.count }</td>
						<td style="border: 1px solid #000;">${invoiceItem.itemName}<br />
						</td>
						<td style="border: 1px solid #000;">${invoiceItem.hsnSac}</td>
						<td style="border: 1px solid #000;">${invoiceItem.qty}bags</td>
						<td style="border: 1px solid #000;">${invoiceItem.ratePerBag}
						</td>
						<td style="border: 1px solid #000;">bags</td>
						<td style="border: 1px solid #000;"></td>
						<td style="border: 1px solid #000;">${ invoiceItem.total }</td>
					</tr>
				</c:forEach>
				...
				<tr>
					...
					<td style="border: 1px solid #000;">
						<table style="width: 100%; border-collapse: collapse">
							<tr>
								<td colspan=2 style="border: 1px solid #000;">Central tax</td>
							</tr>
							<tr>
								<td style="border: 1px solid #000;">Rate</td>
								<td style="border: 1px solid #000;">Amount</td>
					...
					<td style="border: 1px solid #000;">
						<table style="width: 100%; border-collapse: collapse">
							<tr>
								<td colspan=2 style="border: 1px solid #000;">State tax</td>
							</tr>
							<tr>
								<td style="border: 1px solid #000;">Rate</td>
								<td style="border: 1px solid #000;">Amount</td>
	...
	<div style="width: 100%; position: fixed; bottom: 2%; left: 50%;">
		<button onclick="printPage('printArea')">Print this page</button>
	</div>
